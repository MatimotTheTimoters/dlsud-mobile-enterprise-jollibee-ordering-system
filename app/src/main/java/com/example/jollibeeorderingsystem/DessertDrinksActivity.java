...
public class DessertDrinksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dessert_drinks);
    ...
    private void setupButtonClickListeners() {
        // Peach Mango Pie
        findViewById(R.id.btnAddToCartPie).setOnClickListener(v -> btnAddToCartOnClick("Peach Mango Pie", R.id.etQuantityPie));

        // Chocolate Sundae
        findViewById(R.id.btnAddToCartSundae).setOnClickListener(v -> btnAddToCartOnClick("Chocolate Sundae", R.id.etQuantitySundae));

        // Pineapple Juice
        findViewById(R.id.btnAddToCartJuice).setOnClickListener(v -> btnAddToCartOnClick("Pineapple Juice", R.id.etQuantityJuice));

        // Iced Tea
        findViewById(R.id.btnAddToCartTea).setOnClickListener(v -> btnAddToCartOnClick("Iced Tea", R.id.etQuantityTea));
