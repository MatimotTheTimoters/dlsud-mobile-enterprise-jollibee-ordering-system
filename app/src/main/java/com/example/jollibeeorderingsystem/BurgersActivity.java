...
public class BurgersActivity extends AppCompatActivity {
    ...
    private void setupButtonClickListeners() {
        // Yumburger
        findViewById(R.id.btnAddToCartYumburger).setOnClickListener(v -> btnAddToCartOnClick("Yumburger", R.id.etQuantityYumburger));

        // Cheesy Yumburger
        findViewById(R.id.btnAddToCartCheesy).setOnClickListener(v -> btnAddToCartOnClick("Cheesy Yumburger", R.id.etQuantityCheesy));

        // Bacon Cheesy Yumburger
        findViewById(R.id.btnAddToCartBacon).setOnClickListener(v -> btnAddToCartOnClick("Bacon Cheesy Yumburger", R.id.etQuantityBacon));

        // Champ Burger
        findViewById(R.id.btnAddToCartChamp).setOnClickListener(v -> btnAddToCartOnClick("Champ Burger", R.id.etQuantityChamp));
