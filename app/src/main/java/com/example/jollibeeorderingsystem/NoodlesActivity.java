...
public class NoodlesActivity extends AppCompatActivity {
    ...
    private void setupButtonClickListeners() {
        // Jolly Spaghetti
        findViewById(R.id.btnAddToCartSpaghetti).setOnClickListener(v -> btnAddToCartOnClick("Jolly Spaghetti", R.id.etQuantitySpaghetti));

        // Palabok Fiesta
        findViewById(R.id.btnAddToCartPalabok).setOnClickListener(v -> btnAddToCartOnClick("Palabok Fiesta", R.id.etQuantityPalabok));

        // Shanghai Rolls + Noodles
        findViewById(R.id.btnAddToCartShanghai).setOnClickListener(v -> btnAddToCartOnClick("Shanghai Rolls + Noodles", R.id.etQuantityShanghai));

        // Beefy Macaroni Soup
        findViewById(R.id.btnAddToCartMacaroni).setOnClickListener(v -> btnAddToCartOnClick("Beefy Macaroni Soup", R.id.etQuantityMacaroni));
